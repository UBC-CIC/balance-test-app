...
class _AnalyticsPageState extends State<AnalyticsPage> {
  ...
  void initState() {
    ...
    weekAverage = queryScoreAverage(oneWeekAgo, currentTime);
    monthAverage = queryScoreAverage(oneMonthAgo, currentTime);
    previousWeekAverage = queryScoreAverage(twoWeekAgo, oneWeekAgo);
    previousMonthAverage = queryScoreAverage(twoMonthAgo, oneMonthAgo);
  }

  Future<double?> queryScoreAverage(DateTime start, DateTime end) async {
